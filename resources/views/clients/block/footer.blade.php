                ...
                <div class="col col-small" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="footer-widget footer-links">
                        ...
                        <ul class="list-style-three">
                            {{-- <li><a href="{{ route('#') }}">Hướng dẫn viên du lịch tốt nhất</a></li> --}}
                ...
                <div class="col col-md-6 col-10 col-small" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="footer-widget footer-contact">
                        ...
                        <ul class="list-style-one">
                            <li><i class="fal fa-map-marked-alt"></i> Hà Nội, Việt Nam</li>
                            <li><i class="fal fa-envelope"></i> <a
                                    href="mailto:abcxyzemail@gmail.com">abcxyzemail@gmail.com</a></li>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="copyright-text text-center text-lg-start">
                        <p>@Copy 2024 <a href="{{ route('home') }}">Travivu</a>, All rights reserved</p>
                    </div>
                </div>
